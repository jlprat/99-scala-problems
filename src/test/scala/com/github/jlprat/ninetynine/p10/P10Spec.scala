...
import com.github.jlprat.ninetynine.p10.P10._

/**
  * Created by @jlprat on 02/03/2016.
  * Specs for test P10: Run-length encoding of a list (Consecutive duplicates of elements are encoded as tuples (N, E) where N is the number of duplicates of the element E)
  */
